...
<html lang="en" >
    ...
    {
        String up ="update tbl_servicebooking set payment_status='1' where sb_id='"+request.getParameter("sbid")+"'";
        if(con.executeCommand(up))
        {
            %>
      <script type="text/javascript">
            alert("Payment Completed");
            setTimeout(function(){window.location.href='Mybooking.jsp'},100);
        </script>
     <%
        }
    }
                    ...
                    <form method="post">
                        <div class="card space icon-relative">
                         ...
                         <div class="card space icon-relative">
                            ...
                            <input type="text" class="input" value="<%=rate%>" placeholder="Amount">
