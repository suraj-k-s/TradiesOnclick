...
<%
    ...
    if (request.getParameter("rating_data") != null) {
        ...
        String ins = "INSERT INTO tbl_review(user_name,user_rating,user_review,review_datetime,tm_id,customer_id)"
                + "VALUES('" + request.getParameter("user_name") + "','" + request.getParameter("rating_data") + "','" + request.getParameter("user_review") + "',SYSDATE(),'" + request.getParameter("labour_id") + "','"+session.getAttribute("Cid")+"')";
    ...
    if (request.getParameter("action") != null) {
        ...
        String query = "SELECT * FROM tbl_review where tm_id = '" + request.getParameter("lid") + "' ORDER BY review_id DESC";
       ...
       String up="update tbl_tradesmen set avg_rating= '"+average_rating+"' where tm_id='" + request.getParameter("lid") + "'   ";
