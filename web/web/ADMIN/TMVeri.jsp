<%-- 
    Document   : TMVeri
    Created on : 1 Jun, 2023, 11:17:19 AM
    Author     : User
--%>
...
<html>
    ...
    <body>
        ...
        if (request.getParameter("aid")!=null)
        {
            ...
            String upa="update tbl_tradesmen set tm_vstatus=1 where tm_id='"+request.getParameter("aid")+"'";
            co.executeCommand(upa);
            
           response.sendRedirect("TMVeri.jsp");
           
            
        }
        if (request.getParameter("rid")!=null)
        {
            String upr="update tbl_tradesmen set tm_vstatus=2 where tm_id='"+request.getParameter("rid")+"'";
        ...
        <form method="post" >
            <table border ="2" align="center">
               ...
               <td><b>PROOF</b></td>
                ...
                <%
                    int i=0;
                String sel="select * from tbl_tradesmen where tm_vstatus=0";
                   ...
                   if(re1.next() & resy.next())
                   {
                    ...
                    <tr>
                        <td><%=i%></td>
                                ...
                                <td><a href="TMVeri.jsp?aid=<%=re.getString("tm_id")%>">ACCEPT</a>
                               <a href="TMVeri.jsp?rid=<%=re.getString("tm_id")%>">REJECT</a></td>
                    </tr>
                    <%
                   }
                }
