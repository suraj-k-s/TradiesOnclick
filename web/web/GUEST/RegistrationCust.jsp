        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form"    action="../Assets/ActionPages/custAction.jsp" enctype="multipart/form-data">
                ...
                title="Phone number with 7-9 and remaing 9 digit with 0-9"/>
                        ...
                        <div class="form-group" >Place
                           <select name="place"  class="form-input" placeholder="Select Your Place" required>
                               <option></option>
                            <%
