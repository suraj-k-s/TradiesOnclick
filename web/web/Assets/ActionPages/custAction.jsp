<%-- 
    Document   : custAction
    Created on : 1 Jun, 2023, 12:08:28 PM
    Author     : User
--%>
...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("photo"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\CUSTOMER\\";//path for storing image
           ...
           //to upload proof of doctor
               ...
               // {//Strinh str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_customer(customer_name,customer_address,customer_contact,customer_email,localPlace_id,customer_password,customer_reg_date)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + value[5] + "',curdate())";
