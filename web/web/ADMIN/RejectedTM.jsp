<%-- 
    Document   : RejTM
    Created on : 1 Jun, 2023, 11:46:01 AM
    Author     : User
--%>
...
if (request.getParameter("aid")!=null)
        {
           ...
           response.sendRedirect("RejectedTM.jsp");
       ...
       <form method="post" >
            <table border ="2" align="center">
               ...
               <td><b>PROOF</b></td>
                ...
                <%
                    int i=0;
                String sel="select * from tbl_tradesmen where tm_vstatus=2";
                   ...
                   if(re1.next() & resy.next())
                   {
                    ...
                    <tr>
                        <td><%=i%></td>
                                ...
                                <td><a href="RejectedTM.jsp?aid=<%=re.getString("tm_id")%>">ACCEPT</a>
                               </td>
                    </tr>
                    <%
                   }
